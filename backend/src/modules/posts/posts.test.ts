...
describe("POST /posts", () => {
  it("should create a new post and return it with a 201 status code", async () => {
    ...
    app.decorate("transactions", {
      ...
      tagged: {
        getAll: jest.fn(), // minimal stub to satisfy the type
      },
    });
  ...
  it("should get all posts and return them with a 200 status code", async () => {
    ...
    const mockPosts= [
      {id: 1, img_url: "http://example.com/one.jpg", caption: "First" },
      {id: 2, img_url: "http://example.com/two.jpg", caption: "second" },
    ];
